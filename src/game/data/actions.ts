...
export const ACTIONS: ActionDef[] = [
  ...
  },
  {
    ...
    warFrontEffects: [
      { frontId: 'financial-war-front', intensity: -5, momentum: -5, modifier: 'Continuity authority' },
  ...
  },
  {
    ...
    warFrontEffects: [{ frontId: 'financial-war-front', intensity: -6, momentum: -6, modifier: 'Financial ringfence' }],
    cooldown: 6,
  },
  {
