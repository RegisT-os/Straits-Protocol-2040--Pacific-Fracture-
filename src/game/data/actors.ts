  ...
  // -------------------------------------------------------------------------
  {
    ...
    moves: [
      ...
      },
      {
        ...
        pressureCampaigns: [{ templateId: 'pnt-degradation-cycle', intensity: 1, durationWeeks: 3 }],
        phases: [3, 4, 5],
  ...
  // -------------------------------------------------------------------------
  {
    ...
    moves: [
      ...
      },
      {
        ...
        pressureCampaigns: [
          { templateId: 'russia-grey-zone-cyber' },
          { templateId: 'pnt-degradation-cycle', intensity: 1, durationWeeks: 3 },
        ],
