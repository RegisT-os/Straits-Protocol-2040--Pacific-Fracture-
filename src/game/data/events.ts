...
export const EVENTS: EventDef[] = [
  ...
  },
  {
    ...
    phases: [1, 2, 3],
    weight: 3,
    incidents: [{ incidentId: 'undersea-cable-instability', nodeId: 'cable-landing-zone' }],
    once: true,
  ...
  },
  {
    ...
    phases: [2, 3],
    weight: 3,
    incidents: [{ incidentId: 'gps-spoofing-malacca', nodeId: 'malacca-strait' }],
    nodeEffects: [{ nodeId: 'emergency-nav-mesh', riskLevel: 6 }],
    cooldown: 10,
  ...
  },
  {
    ...
    phases: [1, 2, 3, 4, 5],
    weight: 2,
    nodeEffects: [{ nodeId: 'payment-rails', riskLevel: 5, cyberExposure: 3 }],
    cooldown: 8,
  ...
  },
  {
    ...
    weight: 2,
    nodeEffects: [
      { nodeId: 'malaysian-eez', riskLevel: 6 },
      { nodeId: 'luconia-shoals', riskLevel: 5 },
    ],
    cooldown: 10,
  ...
  },
  {
    ...
    phases: [4, 5],
    weight: 3,
    incidents: [{ incidentId: 'asean-summit-deadlock', nodeId: 'jakarta' }],
    once: true,
    choices: [
      {
        id: 'push-unity',
        ...
        nodeEffects: [
          { nodeId: 'jakarta', stability: 4 },
          { nodeId: 'bangkok', stability: 2 },
          { nodeId: 'manila', stability: 2 },
        ],
      ...
      },
      {
        ...
        nodeEffects: [{ nodeId: 'jakarta', riskLevel: 3 }],
  ...
  },
  {
    ...
    phases: [3, 4],
    weight: 3,
    incidents: [{ incidentId: 'satellite-internet-interruption', nodeId: 'commercial-satnet' }],
    cooldown: 10,
